...
export default function Market() {
  ...
  async function handleOpenCamera() {
    try {
      ...
      if(!granted) {
        return Alert.alert("Câmera", "É necessário permitir o acesso a camera")
      }
  ...
  async function getCoupon(id: string) {
    try {
      ...
      Alert.alert("Erro", "Não foi possivel utilizar cupom")
    } finally {
  ...
  function handleUseCoupon(id: string) {
    ...
    Alert.alert("Cupom", "Não é possivel reutilizar um cupom resgatado. Deseja realmente o cupom?", [
      {
        text: "Não",
        style: "cancel"
      },
